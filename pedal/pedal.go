...
var pedals = []Pedal {
    ...
    Pedal{ptype: 33751074, active: true, stype: "Modulation", name: "Phaser",
        params: []Parameter{
            ...
            &PerCentParam{name: "Depth", value:0},
            &PerCentParam{name: "Fdbk", value:0},
            &PerCentParam{name: "Stages", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    Pedal{ptype: 33751075, active: true, stype: "Modulation", name: "Dual Phaser",
        params: []Parameter{
            ...
            &PerCentParam{name: "Depth", value:0},
            &PerCentParam{name: "Fdbk", value:0},
            &PerCentParam{name: "LfoShp", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 33751079, active: true, stype: "Modulation", name: "Rotary Drum",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Speed", value:0},
            &PerCentParam{name: "Depth", value:0},
    ...
    Pedal{ptype: 33751082, active: true, stype: "Modulation", name: "Analog Chorus",
        params: []Parameter{
            ...
            &PerCentParam{name: "Speed", value:0},
            &PerCentParam{name: "Depth", value:0},
            &PerCentParam{name: "Ch Vib", value:0},
            &PerCentParam{name: "Tone", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    Pedal{ptype: 33751083, active: true, stype: "Modulation", name: "Dimension",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Sw1", value:0},
            &PerCentParam{name: "Sw2", value:0},
            &PerCentParam{name: "Sw3", value:0},
            &PerCentParam{name: "Sw4", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 33751104, active: true, stype: "Modulation", name: "Barberpole Phaser",
        params: []Parameter{
            ...
            &NullParam{},
            &PerCentParam{name: "Fdbk", value:0},
            &PerCentParam{name: "Mode", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 33751107, active: true, stype: "Modulation", name: "Pattern Tremolo",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Speed", value:0},
            &PerCentParam{name: "Step1", value:0},
            &PerCentParam{name: "Step2", value:0},
            &PerCentParam{name: "Step3", value:0},
            &PerCentParam{name: "Step4", value:0},
            }},
    ...
    Pedal{ptype: 33751113, active: true, stype: "Modulation", name: "80A Flanger",
        params: []Parameter{
            ...
            &PerCentParam{name: "Manual", value:0},
            &PerCentParam{name: "Even Odd", value:0},
            }},
    /*
     * Reverb section
     */
    ...
    Pedal{ptype: 34209807, active: true, stype: "Filter", name: "Tron Up",
        params: []Parameter{
            ...
            &PerCentParam{name: "Range", value:0},
            &PerCentParam{name: "Type", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 34209809, active: true, stype: "Filter", name: "Seeker",
        params: []Parameter{
            ...
            &PerCentParam{name: "Freq", value:0},
            &PerCentParam{name: "Q", value:0},
            &PerCentParam{name: "Steps", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 34209813, active: true, stype: "Filter", name: "Throbber",
        params: []Parameter{
            ...
            &PerCentParam{name: "Freq", value:0},
            &PerCentParam{name: "Q", value:0},
            &PerCentParam{name: "Wave", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 34209821, active: true, stype: "Filter", name: "Voice Box",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Speed", value:0},
            &PerCentParam{name: "Start", value:0},
            &PerCentParam{name: "End", value:0},
            &PerCentParam{name: "Auto", value:0},
            &PerCentParam{name: "Mix", value:0},
            }},
    ...
    Pedal{ptype: 34340873, active: true, stype: "Preamp+EQ", name: "Graphic EQ",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "80Hz", value:0},
            &PerCentParam{name: "220Hz", value:0},
            &PerCentParam{name: "480Hz", value:0},
            &PerCentParam{name: "1.1kHz", value:0},
            &PerCentParam{name: "2.2kHz", value:0},
            }},
    Pedal{ptype: 34340874, active: true, stype: "Preamp+EQ", name: "Studio EQ",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Low Freq", value:0},
            &PerCentParam{name: "Low Gain", value:0},
            &PerCentParam{name: "Hi Freq", value:0},
            &PerCentParam{name: "Hi Gain", value:0},
            &PerCentParam{name: "Gain", value:0},
            }},
    ...
    Pedal{ptype: 34340876, active: true, stype: "Preamp+EQ", name: "4 Band Shift EQ",
        params: []Parameter{
            &NullParam{},
            &PerCentParam{name: "Low", value:0},
            &PerCentParam{name: "Low Mid", value:0},
            &PerCentParam{name: "Hi Mid", value:0},
            &PerCentParam{name: "Hi", value:0},
            &PerCentParam{name: "Shift", value:0},
            }},
    ...
    Pedal{ptype: 34340878, active: true, stype: "Preamp+EQ", name: "Vintage Pre",
        params: []Parameter{
            ...
            &PerCentParam{name: "Gain", value:0},
            &PerCentParam{name: "Output", value:0},
            &PerCentParam{name: "Phase", value:0},
            &PerCentParam{name: "Hi Pass Filter", value:0},
            &PerCentParam{name: "Low pass Filter", value:0},
            }},
}
